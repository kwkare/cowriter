...
from cowriter.config import Config
from cowriter.error import exceptionHandler
from cowriter.shared import SharedData
...
__package__    = "cowriter"
__copyright__  = "Copyright 2018-2025 Veronica Berglyd Olsen (original), CoWriter Contributors"
__license__    = "GPLv3"
__author__     = "CoWriter Contributors"
__maintainer__ = "CoWriter Contributors"
__email__      = "cowriter@example.com"
__version__    = "26.2a0"
__hexversion__ = "0x260200a0"
__date__       = "2026-04-13"
__status__     = "Stable"
__domain__     = "cowriter.example.com"
...
def main(sysArgs: list | None = None) -> GuiMain | None:
    ...
    if sys.platform == "darwin":
        ...
        try:
            import ctypes
            appID = f"io.cowriter.{__version__}"
