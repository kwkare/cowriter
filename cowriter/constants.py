...
class nwConst:
    ...
    URL_CODE     = "https://github.com/YOUR_USERNAME/cowriter"
    URL_REPORT   = "https://github.com/YOUR_USERNAME/cowriter/issues"
    URL_HELP     = "https://github.com/YOUR_USERNAME/cowriter/discussions"

    # Requests
    USER_AGENT = "Mozilla/5.0 (compatible; CoWriter (Python))"

    # Mime Types
    MIME_HANDLE = "text/vnd.cowriter.handle"
