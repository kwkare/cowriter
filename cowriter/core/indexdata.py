...
from cowriter.common import checkInt, compact, isListInstance, isTitleTag
from cowriter.constants import nwKeyWords, nwStyles

if TYPE_CHECKING:
    from collections.abc import ItemsView, Sequence

    from cowriter.core.index import IndexCache
