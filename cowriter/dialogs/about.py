...
from cowriter.common import formatLink, readTextFile
from cowriter.enum import nwStandardButton
from cowriter.extensions.configlayout import NColorLabel
from cowriter.extensions.modified import NDialog
from cowriter.extensions.versioninfo import VersionInfoWidget
from cowriter.types import QtAlignRightTop, QtHexArgb, QtRoleDestruct
...
class GuiAbout(NDialog):
    ...
    def __init__(self, parent: QWidget) -> None:
        ...
        self.setWindowTitle(self.tr("About CoWriter"))
        self.resize(700, 500)
