...
from cowriter.common import compact, describeFont, processDialogSymbols, uniqueCompact
from cowriter.config import DEF_GUI_DARK, DEF_GUI_LIGHT, DEF_ICONS, DEF_TREECOL
from cowriter.constants import nwLabels, nwQuotes, nwUnicode, trConst
from cowriter.dialogs.quotes import GuiQuoteSelect
from cowriter.enum import nwStandardButton
from cowriter.extensions.configlayout import NColorLabel, NScrollableForm
...
from cowriter.types import QtAlignCenter, QtRoleAccept, QtRoleReject
