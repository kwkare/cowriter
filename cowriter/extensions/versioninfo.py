...
from cowriter import CONFIG, SHARED, __date__, __domain__, __version__
from cowriter.common import formatLink, formatVersion
from cowriter.constants import nwConst

logger = logging.getLogger(__name__)

API_URL = "https://api.github.com/repos/vkbo/cowriter/releases/latest"
