...
from cowriter.common import checkInt, minmax, safeIsFile
...
from cowriter.extensions.modified import NIconToolButton, NPushButton
...
class GuiIcons:
    ...
    IMAGE_MAP: Final[dict[str, tuple[str, str]]] = {
        ...
        "nw-text":  ("cowriter-text-light.svg", "cowriter-text-dark.svg"),
    }
    ...
    def _loadIcon(self, name: str, color: str | None = None, w: int = 24, h: int = 24) -> QIcon:
        ...
        if name == "cowriter":
            return QIcon(str(CONFIG.assetPath("icons") / "cowriter.svg"))
        elif name == "proj_nwx":
            return QIcon(str(CONFIG.assetPath("icons") / "x-cowriter-project.svg"))
