...
from cowriter import CONFIG, SHARED, __hexversion__, __version__
from cowriter.common import formatFileFilter, formatVersion, hexToInt, minmax, safeIsFile
...
from cowriter.enum import (
    nwDocAction, nwDocInsert, nwDocMode, nwFocus, nwItemType, nwView, nwVimMode
)
from cowriter.extensions.progressbars import NProgressSimple
from cowriter.gui.doceditor import GuiDocEditor
from cowriter.gui.docviewer import GuiDocViewer
from cowriter.gui.docviewerpanel import GuiDocViewerPanel
from cowriter.gui.itemdetails import GuiItemDetails
from cowriter.gui.mainmenu import GuiMainMenu
from cowriter.gui.noveltree import GuiNovelView
from cowriter.gui.outline import GuiOutlineView
from cowriter.gui.projtree import GuiProjectView
from cowriter.gui.search import GuiProjectSearch
from cowriter.gui.sidebar import GuiSideBar
from cowriter.gui.statusbar import GuiMainStatus
...
from cowriter.gui.aichat import GuiAIChatPanel, GuiAICompleteDialog
from cowriter.types import QtModShift
...
class GuiMain(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        nwIcon = CONFIG.assetPath("icons") / "cowriter.svg"
        ...
        logger.info("CoWriter is ready ...")
        self.mainStatus.setStatusMessage(self.tr("CoWriter is ready ..."))
        CONFIG.splashMessage("CoWriter is ready ...")
    ...
    def postLaunchTasks(self, cmdOpen: str | None) -> None:
        ...
        if hexToInt(CONFIG.lastNotes) < hexToInt(__hexversion__):
            ...
            SHARED.info([
            self.tr(
                "You are now running CoWriter version {0}."
    ...
    def showAboutNWDialog(self) -> None:
        """Show the CoWriter about dialog."""
    ...
    def _processConfigChanges(self, restart: bool, tree: bool, theme: bool, syntax: bool) -> None:
        ...
        if restart:
            SHARED.info(self.tr(
                "Some changes will not be applied until CoWriter has been restarted."
            ))
