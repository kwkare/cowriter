...
from cowriter.common import appendIfSet, formatFileFilter, joinLines
from cowriter.constants import nwFiles
from cowriter.core.spellcheck import NWSpellEnchant
from cowriter.enum import nwChange, nwItemClass, nwStandardButton
from cowriter.types import QtSizeExpanding, QtSizeMinimum

if TYPE_CHECKING:
    from collections.abc import Callable

    from cowriter.core.project import NWProject
    from cowriter.core.status import T_StatusKind
    from cowriter.gui.theme import GuiTheme
    from cowriter.guimain import GuiMain
    from cowriter.types import T_MsgSeverity
...
class SharedData(QObject):
    ...
    def _closeToolDialogs(self) -> None:
        ...
        from cowriter.extensions.modified import NToolDialog
        for widget in self.mainGui.children():
