...
from cowriter.common import formatInt, makeFileNameSafe, qtAddAction, safeIsFile
from cowriter.constants import nwFiles
from cowriter.core.coretools import ProjectBuilder
from cowriter.enum import nwItemClass, nwStandardButton
from cowriter.extensions.configlayout import NColorLabel, NWrappedWidgetBox
from cowriter.extensions.modified import NDialog, NIconToolButton, NSpinBox
from cowriter.extensions.switch import NSwitch
from cowriter.extensions.versioninfo import VersionInfoWidget
...
class GuiWelcome(NDialog):
    ...
    def __init__(self, parent: QWidget) -> None:
        ...
        self.nwLogo.setPixmap(SHARED.theme.getPixmap("cowriter", (128, 128)))
